...
class SocialCheckoutWidget extends StatefulWidget {
  SocialCheckoutWidget({Key key}) : super(key: key);

  @override
  _SocialCheckoutWidgetState createState() => _SocialCheckoutWidgetState();
}

class _SocialCheckoutWidgetState extends State<SocialCheckoutWidget> {
